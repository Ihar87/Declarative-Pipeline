    ...
    stage("Syntax check"){
      steps {
        script {
          ...
          withCredentials([usernamePassword(credentialsId: "Jenkins_http_connection", passwordVariable: 'cce3aacfdbbdcf0664b9ab030158cf26', usernameVariable: 'build_runner')]) {
